...
#     USER_IMAGE_PATH = os.path.join(BASE_DIR, USER_DIR)
    ...
    MODEL_TASK_PATH =r'/home/ec2-user/SageMaker/scikit_learn_bring_your_own_model_2024-02-27/code'

    def __init__(self, user_img_file, model):

#         self.img_file = os.path.join(self.USER_IMAGE_PATH,user_img_file)
        self.img_file = user_img_file
        self.model = model
...
#       aslModelDict = joblib.load(open(self.MODEL_PATH, 'rb'))
        aslModelDict = joblib.load(open(self.model, 'rb'))
